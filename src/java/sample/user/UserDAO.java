...
public class UserDAO {
    ...
    private static String UPDATE2 = "UPDATE tblUsers SET userID=? WHERE fullName=?";
    ...
    private static String TOP1 = "SELECT TOP (1) [userID],[fullName],[password],[roleID] FROM [dbo].[tblUsers]";
    ...
    public UserDTO checkLogin(String userID, String password) throws SQLException {
     ...
     public List<UserDTO> GetlistTop1() throws SQLException {
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    String roleID = rs.getString("roleID");
                    String password = "***";
                    list2.add(new UserDTO(userID, fullName, roleID, password));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
